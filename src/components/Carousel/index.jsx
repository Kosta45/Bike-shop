...
//--------------------------------------------------------НАПОМИНАЛКА!!!!!-----------------------------------------------------------------------------
// Карусель можно будет дополнить фотками. Или если захочешь можешь сделать функции бесконечной прокрутки!!! 28.11.2022 Ты хотел оставить проект таким!
//-----------------------------------------------------------------------------------------------------------------------------------------------------
import {
    Arrow,
    SlideBtn,
...
// Ниже код который возвращает уже саму карусельку -----------------------------------------
        ...
        <div>
            <Container ref={containerRef} width={width} height={height}>
                ...
                <CarouselTrack transform={transform}>
                    {children.map((item, i) => (
                        <ContainerItem key={"conteiner_item_key" + i}
                            width={width}
                            height={height}
                        >
                        {item}
